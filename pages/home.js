    ...
    <>
      <div className="home-container">
        <Head>
          ...
          <meta property="og:title" content="Home - Landing Page" />
        </Head>
          ...
          <div className="home-navbar">
            <div className="home-left-side">
              ...
              <div className="home-links-container">
                <span className="home-link01 Anchor">Resources</span>
            ...
            <div data-role="MobileMenu" className="home-mobile-menu">
              ...
              <div className="home-links-container1">
                <span className="home-link03 Anchor">Resources</span>
                ...
                <a href="#ourstory" className="home-link06 Anchor">
                  Our story
                </a>
              </div>
            </div>
            ...
            <div className="home-container03">
              <div className="home-container04">
                <h1 className="home-heading">
                  ...
                  <span className="home-text003">Empower Dreams.</span>
                </h1>
        ...
        <div className="home-get-started">
          ...
          <div className="home-container11">
            ...
            <h3 className="home-text037">
              <span className="home-text038">Objectives</span>
              <br></br>
            </h3>
            ...
            <h3 className="home-text042">
              <span>ELIGIBILITY CRITERIA</span>
              <br></br>
            </h3>
            <span className="home-text045">Applicants must:</span>
            ...
            <span className="home-text063">A) Via your School</span>
            <ul className="home-how-to-apply-list-a list">
              ...
              <li className="list-item">
                ...
                <ul className="home-ul2 list">
                  <li className="list-item">
                    <span className="home-text066">WAEC/NECO result</span>
                  </li>
                  <li className="list-item">
                  ...
                  <li className="list-item">
                    ...
                    <ul className="home-ul3 list">
                      ...
                      <li className="list-item">
                        <span className="home-text076">Reputable Clergy</span>
                      </li>
                    </ul>
                  </li>
                </ul>
            ...
            <span className="home-text078">B) Online</span>
            ...
            <ul className="home-more-information-list list">
              ...
              <li className="home-li32 list-item">
                <span className="home-text103">Send an email to</span>
                <a
        ...
        <div id="inspiration" className="home-features">
          <div className="home-heading-container">
            <h2 className="home-text106 Section-Heading">
          ...
          <div className="home-cards-container">
            <div className="home-features-card">
              ...
              <div className="home-text-container">
                ...
                <span className="home-text107 Card-Text">
            ...
            <div className="home-features-card1">
              ...
              <div className="home-text-container1">
                ...
                <span className="home-text108 Card-Text">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Integer nec odio. Praesent libero. Sed cursus ante dapibus
                  diam.c Sed nisi. Nulla quis sem at nibh elementum imperdiet.
                </span>
            ...
            <div className="home-features-card2">
              ...
              <div className="home-text-container2">
                ...
                <span className="home-text109 Card-Text">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Integer nec odio. Praesent libero. Sed cursus ante dapibus
                  diam.c Sed nisi. Nulla quis sem at nibh elementum imperdiet.
                </span>
            ...
            <div className="home-features-card4">
              ...
              <div className="home-text-container4">
                ...
                <span className="home-text111 Card-Text">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Integer nec odio. Praesent libero. Sed cursus ante dapibus
                  diam.c Sed nisi. Nulla quis sem at nibh elementum imperdiet.
                </span>
        ...
        <div id="process" className="home-services">
          <div className="home-heading-container1">
            <h1 className="home-text113 Section-Heading">
              More things to explore
            </h1>
            <span className="home-text114 Section-Text">
          ...
          <div className="home-cards-container1">
            <div className="home-service-card">
              <h3 className="home-text115 Card-Heading">Resources</h3>
              <span className="home-text116 Card-Text">
            ...
            <div className="home-service-card1">
              <h3 className="home-text117 Card-Heading">Community</h3>
              <span className="home-text118 Card-Text">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                nec odio. Praesent libero.
                <span
                  dangerouslySetInnerHTML={{
            ...
            <div className="home-service-card2">
              <h3 className="home-text119 Card-Heading">Newsroom</h3>
        ...
        <div className="home-team">
          <div className="home-heading-container2">
            <h1 className="home-text121 Section-Heading">Meet the Team</h1>
            <span className="home-text122 Section-Text">
              Lorme ipsum dolor sit amet, consectetur adipiscing elit. Integer
              nec odio. Praesent libero.
            </span>
          </div>
        ...
        <div id="ourstory" className="home-our-story">
          <div className="home-heading-container3">
            <h1 className="home-text123 Section-Heading">Our story</h1>
            <span className="home-text124 Section-Text">
              Lorme ipsum dolor sit amet, consectetur adipiscing elit. Integer
              nec odio. Praesent libero.
            </span>
          </div>
          <div className="home-cards-container3">
            <div className="home-left-section">
              ...
              <div className="home-content-container">
                ...
                <span className="home-text125 Card-Text">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Integer nec odio. Praesent libero. Sed cursus ante dapibus
                  diam.c Sed nisi. Nulla quis sem at nibh elementum imperdiet.
                ...
                <span className="home-text126 Card-Text">
                  {' '}
            ...
            <div className="home-right-section">
              ...
              <div className="home-card2">
                ...
                <div className="home-content-container3">
                  <span className="home-text135 SmallCard-Heading">
                    This text is the name of the article. Lorem ipsum dolor sit
                    metsed ...
                  </span>
                  <span className="Anchor">Read more</span>
              ...
              <div className="home-card3">
                ...
                <div className="home-content-container4">
                  <span className="home-text138 SmallCard-Heading">
                    This text is the name of the article. Lorem ipsum dolor sit
                    metsed ...
                  </span>
                  <span className="Anchor">Read more</span>
        ...
        <div className="home-get-in-touch">
          <h2 className="home-text141 Section-Heading">Get in touch</h2>
